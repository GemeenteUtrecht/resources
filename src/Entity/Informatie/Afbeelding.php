...
class Afbeelding implements StringableInterface
{
    ...
    public function getOrigineleNaam(): ?string
    {
        return $this->origineleNaam;
    }

    public function setOrigineleNaam(string $origineleNaam): self
    {
    ...
    public function getRegistratiedatum(): ?Informatie
    {
        return $this->registratiedatum;
    }

    public function setRegistratiedatum(?Informatie $registratiedatum): self
    {
